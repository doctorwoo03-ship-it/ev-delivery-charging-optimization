...
const roadmap = [
  ...
  {
    stage: 'MVP-8',
    title: '통합 드라이버 플로우 코크핏',
    path: '/mvp-flow/mvp-8',
    status: 'inprogress',
    features: [
      '차량 선택 → SOC 설정 → 출발지 → 배송지 → 경로 → 충전소 → 의사결정 통합 플로우',
      '배터리 SOC 및 최소 도착 SOC 설정',
      '실도로 기반 배송 경로 계산 및 충전소 추천 · 우회 결정',
      '경로 건강 점수 및 EV 인텔리전스 설명 패널 통합',
      '지도 중심 내비게이션형 드라이버 코크핏 고도화',
      '실시간 충전소 API 연동 준비 (chargerService provider 구조)',
    ],
  },
]
